...
try {
  ...
  console.log('PASS: интерактивная карта, решение с источником, проект формулировки, восстановление плана, фильтры, счётчик LLM, демо и цитаты; ошибок JavaScript нет.');
} finally {
